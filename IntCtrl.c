...
//	/*32 bit timer*/
//	GPTMCFG_Timer_1_R                    = 0x0                         ;  /*select 16-bit configuration option */
//	GPTMTAMR_TimerA_1_R                  = 0x02                        ;  /*select periodic down counter mode of timer1 */
//	//GPTMTAPR_TimerA_1_R                  = ((250-1) )                      ;  /* (8 bit register)TimerA prescaler value to divide 16MHz over 250 */
//	GPTMTAILR_TimreA_1_R                 = (64000*250) - 1                   ;  /* (16 bit)TimerA counter starting count down value 64000 equal 1Second after prescaling */
//	
	/* 16 bit timer*/
	
	GPTMCFG_Timer_1_R                    = 0x04                         ;  /*select 16-bit configuration option */
	GPTMTAMR_TimerA_1_R                  = 0x02                        ;  /*select periodic down counter mode of timer1 */
	GPTMTAPR_TimerA_1_R                  = (250-1)                     ;  /* (8 bit register)TimerA prescaler value to divide 16MHz over 250 */
	GPTMTAILR_TimreA_1_R                 = (64000) - 1                   ;  /* (16 bit)TimerA counter starting count down value 64000 equal 1Second after prescaling */
